...
\frame{
	...
	\begin{itemize}[<+->]
		\item LWE was an attempt to solve lattice problems
		\item Worst-case lattice problems reduce to LWE
		\item Need of new encryption schemes that are at least as hard to
			break as solving problems difficult for quantum computers
